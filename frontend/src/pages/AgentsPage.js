...
export default function AgentsPage() {
  ...
  return (
    <div className="h-screen flex flex-col bg-[#F8FAFC]">
      <AppHeader currentPage="agents" onNavigate={(page) => navigate(page === 'dashboard' ? '/dashboard' : page === 'contacts' ? '/contacts' : page === 'calendar' ? '/calendar' : page === 'agents' ? '/agents' : page === 'admin' ? '/admin' : '/')} />
